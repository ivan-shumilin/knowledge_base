...
Типы данных и переменные .
  type [python#Type(object)] With one argument, return the type of an object. 
  Числа [Numbers] .
    Int .
    | number1 = 42
    Float .
...
Библиотеки .
  Prompt .
  . https://prompt.readthedocs.io/en/latest/ 
  . Библиотека |prompt| предоставляет функции, которые запрашивают ввод строк, чисел,
    паролей (вводимый пароль не будет отображаться в консоли!). При этом каждая функция
    сама печатает "приглашение" — текст, который предваряет ввод.А ещё по умолчанию 
    каждая функция повторяет запрос, если пользователь ничего не ввёл, а сразу нажал Enter.
    Это избавляет нас от необходимости запрашивать ввод в цикле. 
Документация .
  На русском (неофициальная, неполная) .
  . https://docs-python.ru/
  На английском (официальная, полная) .
  . https://docs.python.org/3/
Полезное .
  Полностью настроенный python-пакет  .
  . https://github.com/hexlet-boilerplates/python-package
  Пример, в котором есть все от и до.
  В любой непонятной ситуации сравнивайте свое решение с тем, что сделано в этом шаблоне
  Семантическое версионирование .
  . https://semver.org/lang/ru/
  CodeClimate .
  . https://codeclimate.com/
  . Регистрация на CodeClimate (при регистрации выбирайте ветку `Quality`)
    Подключите к нему свой репозиторий.
    Разместите в ридми бейджик Maintainability своего проекта 
    (см. https://codeclimate.com/github/codeclimate/codeclimate/badges).
  Double Dash '--' .
...
Принципы разработки .
  Ссылки .
    ...
    Магические числа: .
    . Википедия https://ru.wikipedia.org/wiki/Магическое_число_(программирование)
    . Урок на code-basics https://ru.code-basics.com/languages/python/lessons/magic-numbers
